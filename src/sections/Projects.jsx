...
const Projects = () => {
  return (
    <div id="projects" className="md:w-4/5 w-5/6 mx-auto pt-24 mb-32">
      <h1 className="text-3xl  font-bold mb-2">
        <span className="text-highlight">04.</span> Projects
      </h1>
      <div className="flex md:flex-row flex-col lg:align-between justify-items-center align-items-center">
